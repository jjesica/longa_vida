...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM bd WHERE Plano_codigo='$id'"; // Ajuste conforme sua tabela
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sqlUpdate)) {
        // Redireciona de volta após atualizar
        header("Location: cadastro.php?msg=Registro atualizado com sucesso!");
        exit;
    } else {
